...
class CourseController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    public function index(Request $request)
    {
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            if($authUser->role_id != 1){
                $courseUsers = DB::table('course_user')->where('user_id', $authUser->id)->pluck('course_id')->toArray();
                
                $query = $query->whereIn('id', $courseUsers);
            }
            // filtering
